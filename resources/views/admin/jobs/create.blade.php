                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body p-0">
                                <form id="quickForm" method="post" action="{{ route('job.store') }}">
                                    @csrf
                                                                    ...
                                                                    <td>
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="form-group col-12">
                                                                                ...
                                                                                <select class="form-control select2"
                                                                                    style="width: 100%;" name="organization">
                                                            ...
                                                            <tbody>
                                                                <tr data-widget="expandable-table" aria-expanded="false">
                                                                    <td>
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="form-group col-12">
                                                                                <textarea class="form-control" id="experience" rows="3" name="responce" required
                                                                                    placeholder="Add responsibilities"></textarea>
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="form-group col-12">
                                                                                <textarea class="form-control" id="experience" rows="3" name="desc" required
                                                                                    placeholder="Add job's description"></textarea>
                                                                            </div>
                                                                        </div>
                                                                        <div class="row">
                                                                            <div class="form-group col-12">
                                                                                <textarea class="form-control" id="experience" rows="3" name="req" required
                                                                                    placeholder="Add job requirements"></textarea>
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                </tr>
